...
void display_text()
{
	bitmap_output(200, 565, "BITONIC SORTING ALGORITHM VISUALISER", GLUT_BITMAP_TIMES_ROMAN_24);//title larger font
...
void front()
{
	...
	bitmap_output(200, 495, "BITONIC SORTING ALGORITHM VISUALISER", GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(198, 490);
	glVertex2f(731, 490);
	glEnd();
...
void main(int argc, char** argv)
{
	...
	glutCreateWindow("Bitonic Sorting Algorithm Visualiser");
	init();
	initialise();
